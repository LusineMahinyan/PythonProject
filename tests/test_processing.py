...
def test_filter_by_state(state: str, expected_count: int):
...
test_data = [
    ...
    {"date": "2023-01-15T12:00:00.000000", "id": 3},  # Такая же дата как у id=1
...
def test_sort_by_date_direction(reverse: bool, expected_order: list[int]):
...
def test_sort_by_date_stable_sort():
...
def test_sort_by_date_invalid_formats(invalid_date: str):
